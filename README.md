...
Матрица инцидентности для игры Доббль под катом ниже. Она транспонирована, т.е. строки - это символы, а столбцы - это карточки (картинка кликабельна).

<details> 
  <summary>Матрица инцидентности игры Доббль.</summary>
